...
export default function Home() {
  return (
    <main className="w-full">
      <div className="bg-[#34353A]  min-h-screen">
        <header className="flex items-center justify-between px-6 pt-2 text-white">
          <div className="flex items-center">
            ...
            />
            <div className="ml-2 ">Michael Rodrigues</div>
          </div>
      ...
      <section
        id="skills"
        className="py-20 flex flex-col items-center justify-center bg-white text-center"
      >
        <h2 className="text-3xl font-semibold mb-4">Habilidades</h2>
        <p className="max-w-2xl text-gray-700">skils here</p>
      </section>
      ...
      >
        ...
        <p className="max-w-2xl text-gray-700">blog here</p>
      </section>

      <section
        id="contact"
        className="py-20 flex flex-col items-center justify-center bg-gray-50 text-center"
      >
        <h2 className="text-3xl font-semibold mb-4">Contato</h2>
        <p className="max-w-2xl text-gray-700">contact here</p>
      </section>
    </main>
  );
}
